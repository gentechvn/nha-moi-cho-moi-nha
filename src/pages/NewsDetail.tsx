          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3">
              <Card className="p-8">
                ...
                <div
                  className="prose prose-lg max-w-none prose-headings:text-foreground prose-h2:text-lg prose-h2:font-bold prose-h2:mt-8 prose-h2:mb-4 prose-h3:text-base prose-h3:font-bold prose-h3:mt-6 prose-h3:mb-3 prose-p:text-muted-foreground prose-p:mb-4 prose-ul:text-muted-foreground prose-ol:text-muted-foreground prose-li:mb-2 prose-strong:text-foreground"
