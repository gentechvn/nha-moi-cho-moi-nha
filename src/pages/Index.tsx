  ...
  const benefits = [
    {
      ...
      description:
        "100% dự án có đầy đủ giấy tờ pháp lý, đảm bảo quyền lợi người mua",
    },
    {
      icon: TrendingUp,
      title: "Giá cả phải chăng",
      description:
        "Giá bán thấp hơn thị trường 20-30%, phù hợp túi tiền người dân",
    },
    {
      icon: CheckCircle2,
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-16 animate-fade-in gap-4">
            ...
            <Link to="/projects" className="hidden sm:block">
              <Button
                variant="outline"
                className="gap-2 border-2 hover:border-primary h-12"
              >
                Xem tất cả
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 text-center animate-fade-in">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-12 max-w-4xl mx-auto">
            {[
              ...
              <div
                key={index}
                className="flex items-center justify-center gap-3 bg-primary-foreground/15 backdrop-blur-md rounded-2xl p-5 border border-primary-foreground/20 hover:scale-105 transition-all duration-300"
              >
