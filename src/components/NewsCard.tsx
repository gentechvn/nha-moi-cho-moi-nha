...
const NewsCard = ({ id, slug, title, excerpt, image, date, category }: NewsCardProps) => {
  return (
    <Link to={`/news/${slug}`} className="block">
      <Card className="group overflow-hidden bg-gradient-card border border-border/50 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 hover:border-primary/30 cursor-pointer h-full">
        ...
        <div className="p-7">
          ...
          <div className="inline-flex items-center text-base font-bold text-primary group-hover:text-primary-light transition-all duration-300 group-hover:gap-3">
            Đọc thêm
